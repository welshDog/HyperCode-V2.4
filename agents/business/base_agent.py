...
Copied from agents/09-tips-tricks-writer/base_agent.py 2026-08-20 — that copy fixed a
prior direct-redis-usage bug the older agents/business/project-strategist/ clone still
had; keep the two in sync if either changes.
"""
