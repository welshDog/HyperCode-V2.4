...
engine = create_async_engine(
    ...
    pool_pre_ping=True,  # Verify connection before handing it out — prevents "database connection lost" errors
    echo_pool=os.getenv("ECHO_DB_POOL", "false").lower() == "true",  # Debug pool exhaustion
)
