...
from app.api.v1.endpoints import skillweaver_proxy as skillweaver_proxy_router  # SkillWeaver synthesis proxy (B3)
...
api_router.include_router(hypersplit.router, prefix="/hypersplit", tags=["hypersplit"])
